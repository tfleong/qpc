...
void Calc_ctor(void) {
    Calc *me = &l_calc;
    QActive_ctor(&me->super, Q_STATE_CAST(&Calc_initial));
}
/*${AOs::Calc} .............................................................*/
/*${AOs::Calc::SM} .........................................................*/
static QState Calc_initial(Calc * const me, QEvt const * const e) {
...
static QState Calc_negated1(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::negated1::DIGIT_0} */
        case DIGIT_0_SIG: {
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
            status_ = Q_TRAN(&Calc_zero1);
            break;
        }
        /* ${AOs::Calc::SM::on::negated1::DIGIT_1_9} */
        case DIGIT_1_9_SIG: {
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
        ...
        /* ${AOs::Calc::SM::on::negated1::OPER} */
        case OPER_SIG: {
            /* ${AOs::Calc::SM::on::negated1::OPER::[e->key=='-']} */
            if (Q_EVT_CAST(CalcEvt)->key_code == KEY_SUB) {
                ;
                status_ = Q_HANDLED();
            }
            /* ${AOs::Calc::SM::on::negated1::OPER::[else]} */
            else {
                status_ = Q_HANDLED();
            }
            break;
        }
        /* ${AOs::Calc::SM::on::negated1::CE} */
        case CE_SIG: {
            BSP_clear();
...
static QState Calc_ready(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::ready::initial} */
        case Q_INIT_SIG: {
            BSP_message("ready-INIT;");
            status_ = Q_TRAN(&Calc_begin);
            break;
        }
        /* ${AOs::Calc::SM::on::ready::DIGIT_0} */
        case DIGIT_0_SIG: {
            BSP_clear();
            status_ = Q_TRAN(&Calc_zero1);
            break;
        }
        /* ${AOs::Calc::SM::on::ready::DIGIT_1_9} */
        case DIGIT_1_9_SIG: {
            BSP_clear();
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
            status_ = Q_TRAN(&Calc_int1);
...
static QState Calc_begin(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::ready::begin::OPER} */
        case OPER_SIG: {
            /* ${AOs::Calc::SM::on::ready::begin::OPER::[e->key=='-']} */
            if (Q_EVT_CAST(CalcEvt)->key_code == KEY_SUB) {
                status_ = Q_TRAN(&Calc_negated1);
            }
            /* ${AOs::Calc::SM::on::ready::begin::OPER::[else]} */
            else {
                status_ = Q_HANDLED();
            }
            break;
...
static QState Calc_operand1(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::operand1::CE} */
        case CE_SIG: {
            BSP_clear();
            status_ = Q_TRAN(&Calc_begin);
            break;
        }
        /* ${AOs::Calc::SM::on::operand1::OPER} */
        case OPER_SIG: {
            me->operand1 = BSP_get_value();
            me->operator = Q_EVT_CAST(CalcEvt)->key_code;
            status_ = Q_TRAN(&Calc_opEntered);
        ...
        /* ${AOs::Calc::SM::on::operand1::EQUALS} */
        case EQUALS_SIG: {
...
static QState Calc_zero1(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::operand1::zero1::DIGIT_0} */
        case DIGIT_0_SIG: {
            ;
            status_ = Q_HANDLED();
            break;
        }
        /* ${AOs::Calc::SM::on::operand1::zero1::DIGIT_1_9} */
        case DIGIT_1_9_SIG: {
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
            status_ = Q_TRAN(&Calc_int1);
            break;
        }
        /* ${AOs::Calc::SM::on::operand1::zero1::POINT} */
        case POINT_SIG: {
            BSP_insert((int)'0');
            BSP_insert((int)'.');
            status_ = Q_TRAN(&Calc_frac1);
...
static QState Calc_int1(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::operand1::int1::POINT} */
        case POINT_SIG: {
            BSP_insert((int)'.');
            status_ = Q_TRAN(&Calc_frac1);
            break;
        }
        /* ${AOs::Calc::SM::on::operand1::int1::DIGIT_0, DIGIT_1_9} */
...
static QState Calc_frac1(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::operand1::frac1::POINT} */
        case POINT_SIG: {
            ;
            status_ = Q_HANDLED();
            break;
        }
        /* ${AOs::Calc::SM::on::operand1::frac1::DIGIT_0, DIGIT_1_9} */
        case DIGIT_0_SIG: /* intentionally fall through */
        case DIGIT_1_9_SIG: {
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
            BSP_display();
...
static QState Calc_opEntered(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::opEntered::DIGIT_0} */
        case DIGIT_0_SIG: {
            BSP_clear();
            status_ = Q_TRAN(&Calc_zero2);
            break;
        }
        /* ${AOs::Calc::SM::on::opEntered::DIGIT_1_9} */
        case DIGIT_1_9_SIG: {
            BSP_clear();
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
        ...
        /* ${AOs::Calc::SM::on::opEntered::POINT} */
        case POINT_SIG: {
            BSP_clear();
            BSP_insert((int)'0');
            BSP_insert((int)'.');
        ...
        /* ${AOs::Calc::SM::on::opEntered::OPER} */
        case OPER_SIG: {
            /* ${AOs::Calc::SM::on::opEntered::OPER::[e->key=='-']} */
            if (Q_EVT_CAST(CalcEvt)->key_code == KEY_SUB) {
                status_ = Q_TRAN(&Calc_negated2);
            }
            /* ${AOs::Calc::SM::on::opEntered::OPER::[else]} */
            else {
                status_ = Q_HANDLED();
            }
            break;
...
static QState Calc_negated2(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::negated2::DIGIT_0} */
        case DIGIT_0_SIG: {
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
            status_ = Q_TRAN(&Calc_zero2);
            break;
        }
        /* ${AOs::Calc::SM::on::negated2::DIGIT_1_9} */
        case DIGIT_1_9_SIG: {
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
            status_ = Q_TRAN(&Calc_int2);
            break;
        ...
        /* ${AOs::Calc::SM::on::negated2::OPER} */
        case OPER_SIG: {
            /* ${AOs::Calc::SM::on::negated2::OPER::[e->key=='-']} */
            if (Q_EVT_CAST(CalcEvt)->key_code == KEY_SUB) {
                ;
                status_ = Q_HANDLED();
            }
            /* ${AOs::Calc::SM::on::negated2::OPER::[else]} */
            else {
                status_ = Q_HANDLED();
            }
            break;
        }
        /* ${AOs::Calc::SM::on::negated2::CE} */
        case CE_SIG: {
            BSP_clear();
            status_ = Q_TRAN(&Calc_opEntered);
            break;
...
static QState Calc_operand2(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::operand2::CE} */
        case CE_SIG: {
            BSP_clear();
            status_ = Q_TRAN(&Calc_opEntered);
            break;
        }
        /* ${AOs::Calc::SM::on::operand2::EQUALS} */
        case EQUALS_SIG: {
            /* ${AOs::Calc::SM::on::operand2::EQUALS::[BSP_eval()]} */
            if (BSP_eval(me->operand1, me->operator, BSP_get_value())) {
                status_ = Q_TRAN(&Calc_result);
            }
            /* ${AOs::Calc::SM::on::operand2::EQUALS::[else]} */
            else {
                status_ = Q_TRAN(&Calc_error);
            }
            break;
        }
        /* ${AOs::Calc::SM::on::operand2::OPER} */
        case OPER_SIG: {
            /* ${AOs::Calc::SM::on::operand2::OPER::[BSP_eval()]} */
            if (BSP_eval(me->operand1, me->operator, BSP_get_value())) {
                me->operand1 = BSP_get_value();
                me->operator = Q_EVT_CAST(CalcEvt)->key_code;
                status_ = Q_TRAN(&Calc_opEntered);
            }
            /* ${AOs::Calc::SM::on::operand2::OPER::[else]} */
            else {
                status_ = Q_TRAN(&Calc_error);
            }
            break;
...
static QState Calc_zero2(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::operand2::zero2::DIGIT_0} */
        case DIGIT_0_SIG: {
            ;
            status_ = Q_HANDLED();
            break;
        }
        /* ${AOs::Calc::SM::on::operand2::zero2::DIGIT_1_9} */
        case DIGIT_1_9_SIG: {
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
            status_ = Q_TRAN(&Calc_int2);
            break;
        }
        /* ${AOs::Calc::SM::on::operand2::zero2::POINT} */
        case POINT_SIG: {
            BSP_insert((int)'0');
            BSP_insert((int)'.');
            status_ = Q_TRAN(&Calc_frac2);
...
static QState Calc_int2(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::operand2::int2::POINT} */
        case POINT_SIG: {
            BSP_insert((int)'.');
            status_ = Q_TRAN(&Calc_frac2);
            break;
        }
        /* ${AOs::Calc::SM::on::operand2::int2::DIGIT_0, DIGIT_1_9} */
        case DIGIT_0_SIG: /* intentionally fall through */
        case DIGIT_1_9_SIG: {
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
            BSP_display();
...
static QState Calc_frac2(Calc * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::Calc::SM::on::operand2::frac2::POINT} */
        case POINT_SIG: {
            ;
            status_ = Q_HANDLED();
            break;
        }
        /* ${AOs::Calc::SM::on::operand2::frac2::DIGIT_0, DIGIT_1_9} */
        case DIGIT_0_SIG: /* intentionally fall through */
        case DIGIT_1_9_SIG: {
            BSP_insert(Q_EVT_CAST(CalcEvt)->key_code);
            BSP_display();
